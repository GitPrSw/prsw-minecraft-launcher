...
def prepare_launch_command(java_path, instance_path, executable_name, maxmem, minmem, versionargs, extra_args, major_version, login_information):
    ...
    command += f' -XX:HeapDumpPath=MojangTricksIntelDriversForPerformance_javaw.exe_minecraft.exe.heapdump -Djava.library.path=%APPDATA%\.minecraft\\versions\\{major_version}\\{executable_name}'